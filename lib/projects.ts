...
export const techColors: Record<string, string> = {
  ...
  OpenClaw: "bg-fuchsia-500/10 text-fuchsia-400",
  ffmpeg: "bg-red-500/10 text-red-400",
...
const rawProjects: ProjectInput[] = [
  ...
  },
  {
    ...
    description:
      "OpenClaw personalizado em Docker: orquestrador self-hosted de agentes de IA com voz local (Whisper com aceleração de GPU), OCR e extração de PDF (Tesseract), automação de navegador (Chromium/Playwright), documentação completa e 4 agentes pré-configurados rodando 24/7 — integrado a serviços self-hosted (busca privada, automação residencial e monitoramento do servidor).",
    tech: ["Docker", "Node.js", "Python", "OpenClaw", "Whisper", "OCR", "Playwright", "ffmpeg", "Tailscale"],
    status: "Pessoal",
